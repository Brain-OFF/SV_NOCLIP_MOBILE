...
public class ModifyUser extends Form {
    ...
    public ModifyUser(Form previous,User user1) {
        ...
        TextField tBio = new TextField("","Bio");
        TextField tPoints = new TextField("","Points");
        TextField tfpassword = new TextField("","Password");
        TextField tfpassword2 = new TextField("","Confirm Password");
        tfusername.setText(user1.getUsername());
        tfemail.setText(user1.getEmail());
        tBio.setText(user1.getBio());
        tPoints.setText(user1.getPoints()+"");
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    try {
                        ...
                        U.setBio(tBio.getText().toString());
                        U.setPoints(Integer.parseInt(tPoints.getText()));
                        U.setId(user1.getId());
        ...
        addAll(lbid,tfusername,tfemail,tBio,tPoints,tfpassword,tfpassword2,btnValider);

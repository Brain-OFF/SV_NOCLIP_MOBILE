 ...
 * @author Taha
 */
public class Tritournoi extends Form {
     Form current;
    ...
    public  Container  addItem(Tournoi u)
    {
       ...
       Label btdate = new Label("date :     "+u.getDateT());
        ...
        cnt.addAll(lbid,lbnom,lbbio,btnmail,btdate,btdelete,btnmodify);
    ...
    return cnt2;
      ...
      public Tritournoi(Form previous) {
        setTitle("List tournois");
        ArrayList<Tournoi> list=ServiceTask.getInstance().getAllTaskT();
